...
//            @edu.umd.cs.findbugs.annotations.SuppressWarnings(value = "NP")
    ...
    private List<Server> bypass(List<Server> servers) {
        final List<Server> preferred = servers.parallelStream().filter(r -> r.getPort() % 2 == 8082 % 2).collect(Collectors.toList());
